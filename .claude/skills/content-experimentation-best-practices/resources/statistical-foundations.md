...
- **Common misconception:** The p-value is NOT "the probability the result is due to chance." It's the probability of observing data this extreme _assuming_ the null hypothesis is true.
